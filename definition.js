...
Blockly.Python["ds1307_gettime"] = function(block) {
  ...
  if (dropdown_data == "NĂM")
    ...
    code = "''.join([str(x) for x in [ds1307.datetime()[2], '/', "{0:0>2}".format(ds1307.datetime()[1]), '/', "{0:0>2}".format(ds1307.datetime()[0]), ' ', "{0:0>2}".format(ds1307.datetime()[4]), ':', "{0:0>2}".format(ds1307.datetime()[5]), ':', "{0:0>2}".format(ds1307.datetime()[6])]])";
